...
class Twenty_Twenty_One_Dark_Mode {
	...
	public function customizer_controls( $wp_customize ) {
		...
		include_once get_theme_file_path( 'classes/class-nguyen-customize-notice-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
