...
function lift_get_breadcrumb() {
    ...
    if (is_home() || is_front_page()) {
        if ($showOnHome == 1) {
            echo '<nav id="breadcrumb" aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="' . $homeLink . '">' . $home . '</a></li></ol></nav>';
        }
    } else {
        echo '<nav id="breadcrumb" aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="' . $homeLink . '">' . $home . '</a></li> ' . $delimiter . ' ';
        if (is_category()) {
