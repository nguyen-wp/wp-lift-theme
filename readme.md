A boilerplate for WordPress theme development using [LIFTCreationsCSS](https://tailwindcss.com/) and [Laravel Mix](https://laravel.com/docs/5.8/mix).
...
1. Run a search & replace across the theme to replace all instances of 'LIFTCreationsCssTheme' with a PHP 
